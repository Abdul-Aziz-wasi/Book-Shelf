...
const Signup = () => {
  ...
  <div className="hero-content flex-col lg:flex-row-reverse gap-6 border border-amber-50 rounded-3xl w-full">
	...
	<p className="text-sm text-center dark:text-gray-600">Already have an account? 
		<NavLink to='/signin' rel="noopener noreferrer" className="focus:underline hover:underline text-blue-600"> Sign In here</NavLink>
	</p>
      <div className="card-body">
       <form onSubmit={handleSignUp}>
         <fieldset className="fieldset">
          ...
          <button className="btn bg-teal-900 text-white mt-4">Sign Up</button>
        
        </fieldset>
       </form>
         <button onClick={handleGoogleSignUp} className="btn bg-teal-900 text-white border-[#e5e5e5]">
