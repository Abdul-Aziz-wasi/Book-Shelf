...
const Faq = () => {
  ...
  <div className="collapse collapse-arrow bg-base-100 border border-base-300">
    ...
    <div className="collapse-title font-semibold text-teal-700">How do I add a new book to my shelf?</div>
    <div className="collapse-content text-sm text-teal-700">
      Navigate to the "Add Book" page from the navigation menu, fill in the book details, and click "Submit".
    </div>
  </div>
  <div className="collapse collapse-arrow bg-base-100 border border-base-300">
    <input type="radio" name="my-accordion-2" />
    <div className="collapse-title font-semibold text-teal-700">Can I edit or delete a book I’ve added?</div>
    <div className="collapse-content text-sm text-teal-700">
  ...
  <div className="collapse collapse-arrow bg-base-100 border border-base-300">
    <input type="radio" name="my-accordion-2" />
    <div className="collapse-title font-semibold text-teal-700">How does the upvote feature work?</div>
    <div className="collapse-content text-sm text-teal-700">
